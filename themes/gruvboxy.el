...
(defgroup doom-gruvboxy-theme nil
  "Options for doom-gruvbox."
  :group 'doom-themes)

;;
(defcustom doom-gruvboxy-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-gruvbox-theme
  :type 'boolean)

(defcustom doom-gruvboxy-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-gruvbox-theme
  :type '(choice integer boolean))

(defcustom doom-gruvboxy-dark-variant nil
...
(def-doom-theme doom-gruvboxy-theme
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg '("#32302f" "#323232" nil))  ;;soft
   ...
   (bg-alt '("#282828" "#282828")) ;; soft
    ;;("#282828" "#282828" nil)
    ;;("#282828" "#282828" nil) ;; soft
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       magenta) ;;(if doom-gruvbox-brighter-comments magenta grey))
   (doc-comments   (doom-lighten magenta 0.2)) ;;(if doom-gruvbox-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       red)
   (methods        green)
